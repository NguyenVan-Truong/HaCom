...
const Banner = () => {
    return (
        <>
            <div className='ml-32 w-full max-w-full'>
                <h2 className=' mt-2 text-xl'><b>Sức mạnh đáng tin cậy</b></h2>
                <p className='mt-2 pb-2 mx-8 w-[1200px] text-left'><b>Asus TUF Gaming A15</b> mang hiệu năng đáng tin cậy để chơi game, thực hiện đa tác vụ với bộ xử lý AMD Ryzen 5 7535HS có thể kích hoạt
